...
void Net::add_conv_layer(int i_ch,int o_ch,int kernel_size,int stride = 1,bool padding = 0)
{
...
{
	auto& [i_ch,o_ch,kernel_size,stride,padding] = conv_configs[Conv_stage_number];
